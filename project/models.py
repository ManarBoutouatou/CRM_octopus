...
class Project (models.Model): 
    ...
    client     = models.ForeignKey(Company, on_delete=models.CASCADE, related_name="projects") 
...
class Transaction(models.Model): 
    ...
    tr_type     = models.CharField(choices=TRANSACTION_TYPE_CHOICES, max_length=2, null=True)
